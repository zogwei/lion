...
public class NettyServerChildChannelHandler extends SimpleChannelInboundHandler<TransportData> {
	...
	public NettyServerChildChannelHandler(MessageHandler messagehandler,ThreadPoolExecutor executor,ConcurrentMap<String, Channel> channels,int MaxChannelNum,NettyServer nettyServer) {
