...
public class LionDigestUtil {

    private static Logger log = LoggerFactory.getLogger(LionDigestUtil.class);
    ...
    public static long getCrc32(String str) {
        try {
            return getCrc32(str.getBytes(LionConstants.DEFAULT_CHARACTER));
