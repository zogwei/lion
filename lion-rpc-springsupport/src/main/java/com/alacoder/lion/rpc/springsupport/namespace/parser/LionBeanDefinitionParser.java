 ...
 * @Title: LionBeanDefinitionParser.java
 * @Package com.alacoder.lion.rpc.springsupport.namespace.parser
 * @Description: 
 * @author jimmy.zhong
 * @date 2016年10月20日 下午7:12:36
 * @version V1.0
 */
...
/**
 * @ClassName: LionBeanDefinitionParser
 * @Description: 
 * @author jimmy.zhong
 * @date 2016年10月20日 下午7:12:36
 *
...
public class LionBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public LionBeanDefinitionParser(Class<?> beanClass, boolean required) {
    ...
    private static BeanDefinition parse(Element element, ParserContext parserContext, Class<?> beanClass, boolean required)
        ...
        if (ProtocolConfig.class.equals(beanClass)) {
            LionNamespaceHandler.protocolDefineNames.add(id);

        } else if (RegistryConfig.class.equals(beanClass)) {
            LionNamespaceHandler.registryDefineNames.add(id);

        } else if (BasicServiceInterfaceConfig.class.equals(beanClass)) {
            LionNamespaceHandler.basicServiceConfigDefineNames.add(id);

        } else if (BasicRefererInterfaceConfig.class.equals(beanClass)) {
            LionNamespaceHandler.basicRefererConfigDefineNames.add(id);
